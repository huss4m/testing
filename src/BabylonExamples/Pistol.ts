...
createMuzzleFlashParticleSystem(): void {
    ...
    this.muzzleFlashParticleSystem.minEmitBox = new Vector3(-8, 7, 100); // Adjust position
    this.muzzleFlashParticleSystem.maxEmitBox = new Vector3(-8, 7, 100); // Adjust position
